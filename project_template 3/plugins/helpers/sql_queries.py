'''
This class serves the purpose of providing data. More specifically, it provides SQL statements to respective custom operator to create fact and dimension tables.

Note the SELECT statements were modified to include INSERT statement.
'''
